...
def main():
    ...
    # update
    his_CSK_XYY_UP_DOWN_120D_RC = ff.read('CSK_XYY_UP_DOWN_120D_RC').to_dict()
    new_CSK_XYY_UP_DOWN_120D_RC = (CSK_XYY_UP_DOWN_120D_neu.shift(1,axis = 1) * ff.filter0).iloc[:,-update_win:].to_dict()
    his_CSK_XYY_UP_DOWN_120D_RC.update(new_CSK_XYY_UP_DOWN_120D_RC)
    his_CSK_XYY_UP_DOWN_120D_RC = pd.DataFrame(his_CSK_XYY_UP_DOWN_120D_RC)

    # check
    assert check(ff.read('CSK_XYY_UP_DOWN_120D_RC'),his_CSK_XYY_UP_DOWN_120D_RC)
    version_reserve(his_CSK_XYY_UP_DOWN_120D_RC,'CSK_XYY_UP_DOWN_120D_RC') # 旧版本保留
    ff.save('CSK_XYY_UP_DOWN_120D_RC',his_CSK_XYY_UP_DOWN_120D_RC)
